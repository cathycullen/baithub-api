...
ActiveRecord::Schema.define(version: 2019_03_04_215218) do
  ...
  create_table "tackle_boxes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["bait_id"], name: "index_tackle_boxes_on_bait_id"
    t.index ["user_id"], name: "index_tackle_boxes_on_user_id"
  end
